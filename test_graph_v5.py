"""
test_graph_v5.py — Graph DES v5 visualizer for oht.large.map.json.

v5 change: X markers are ALWAYS placed at next ZCU node boundary,
regardless of whether a leader OHT exists ahead.
...
from graph_des_v5 import (
    GraphMap, GraphDESv5, Vehicle, random_safe_path,
...
def main():
    ...
    pygame.display.set_caption("Graph DES v5 — X marker always at ZCU boundary")
    ...
    while running:
        ...
        lines = [
            f"t={sim_time:.1f}s x{sim_speed:.1f} {'PAUSED' if paused else ''} [graph-des-v5]",
